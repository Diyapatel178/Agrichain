...
function initDb() {
  ...
  // New fields for extended user profiles
  try {
    db.exec(`ALTER TABLE users ADD COLUMN mobile TEXT DEFAULT NULL;`);
  } catch (e) {}
  ...
  try {
    db.exec(`ALTER TABLE users ADD COLUMN aadhaar_number TEXT DEFAULT NULL;`);
    db.exec(`ALTER TABLE users ADD COLUMN is_aadhaar_verified INTEGER DEFAULT 0;`);
  } catch (e) {}

  try {
    db.exec(`ALTER TABLE products ADD COLUMN photo_url TEXT DEFAULT NULL;`);
    db.exec(`ALTER TABLE products ADD COLUMN video_url TEXT DEFAULT NULL;`);
  } catch (e) {}
